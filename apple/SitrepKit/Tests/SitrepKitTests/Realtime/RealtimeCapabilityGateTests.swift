...
/// Pure decision-logic tests for the transport gate (v1-architecture.md
/// §8): whether a RealtimeClient connection may be opened is decided solely
/// from the most recent snapshot refresh's `capabilities.ws_transport_enabled`.
/// No live socket involved — this exercises `RealtimeCapabilityGate`
/// directly.
