...
// Cardinality cap on SpaceHub#metricsCurrentCache (distinct metric_ids held
// at once, per space) — now defined ONCE in v1/contract/types.ts
// (METRIC_CACHE_MAX_METRICS) and shared with the persistent metrics_current
// table's own cap, rather than drifting independently here (P0-7,
// v1-architecture.md §1.2.0). Import it from there.
