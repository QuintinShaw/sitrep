/* eslint-disable */
// Hand-maintained to match wrangler.jsonc's bindings (UserStore is gone —
// v1-architecture.md §11; INVITE_DIR is gone — §10.5, P0-6; SPACE_HUB and
// SPACE_CREATION_RATE_LIMITER are the two Durable Object bindings).
// Regenerate with `wrangler types` once this branch is wired to a real
// Cloudflare account/deploy; the runtime type bodies below this header are
// otherwise untouched (copied verbatim from the last `wrangler types` run).
...
interface __BaseEnv_Env {
	...
	SPACE_HUB: DurableObjectNamespace<import("./src/adapters/workers").SpaceHub>;
	SPACE_CREATION_RATE_LIMITER: DurableObjectNamespace<import("./src/adapters/workers").SpaceCreationRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/adapters/workers");
		durableNamespaces: "SpaceHub" | "SpaceCreationRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APNS_BUNDLE_ID" | "APNS_HOST" | "WS_TRANSPORT_ENABLED" | "APNS_DELIVERY_ENABLED">> {}
}
