/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0eac4d6591f9e4c5dd04df5e8b07aced)
// Runtime types generated with workerd@1.20260714.1 2026-07-18 nodejs_compat
interface __BaseEnv_Env {
	INVITE_DIR: KVNamespace;
	APNS_BUNDLE_ID: "dev.sitrep.app";
	APNS_HOST: "api.sandbox.push.apple.com";
	REALTIME_ENABLED: false;
	USER_STORE: DurableObjectNamespace<import("./src/adapters/workers").UserStore>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "UserStore" | "SpaceHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APNS_BUNDLE_ID" | "APNS_HOST" | "REALTIME_ENABLED">> {}
}
